...
use st2k_appkit::win::{app_icon, gui_font, set_clipboard_text, t, wide};
...
pub unsafe fn run_eyedropper(hinst: HINSTANCE) {
...
pub unsafe fn run_shot_eyedropper(out: &str) -> bool {
    ...
    st2k_appkit::win::settle_pump(hwnd, 10, 6, true);
