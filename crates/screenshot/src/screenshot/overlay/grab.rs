...
pub(super) unsafe fn build_shot_state(
    ...
    Box::new(Shot {
        ...
        selected: None,
        move_from: None,
        text_font: tools::default_text_font(st2k_appkit::win::dpi_scale_dpi(18, seed_dpi)),
        color_flyout: false,
    ...
    match (copied, saved) {
        ...
        (true, false) => {
            ...
            st2k_appkit::win::notify_toast(
                "SageThumbs 2K",
                st2k_appkit::win::t("toast_shot_fail_save")
                    .replace("{dir}", &dir)
                    .as_str(),
        ...
        (false, true) => {
            ...
            st2k_appkit::win::notify_toast(
                "SageThumbs 2K",
                st2k_appkit::win::t("toast_shot_fail_clip"),
                std::time::Duration::from_secs(5),
            );
        }
        (false, false) => {
            ...
            st2k_appkit::win::notify_toast(
                "SageThumbs 2K",
                st2k_appkit::win::t("toast_shot_fail_all"),
