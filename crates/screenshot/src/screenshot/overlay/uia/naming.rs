...
pub(super) fn text_item_name(item: TextItem, face: &str) -> String {
    match item {
        TextItem::FontField => st2k_appkit::win::t("shot_text_font_field").replace("{face}", face),
        TextItem::FontOption(i) => toolbar::PRESET_FONTS
            .get(i)
            .map_or_else(|| "Font".to_string(), |n| (*n).to_string()),
        TextItem::SizeDown => st2k_appkit::win::t("shot_text_size_down").to_string(),
        TextItem::SizeUp => st2k_appkit::win::t("shot_text_size_up").to_string(),
        TextItem::Bold => st2k_appkit::win::t("shot_text_bold").to_string(),
        TextItem::Underline => st2k_appkit::win::t("shot_text_underline").to_string(),
        TextItem::More => st2k_appkit::win::t("shot_text_more_options").to_string(),
    }
}
