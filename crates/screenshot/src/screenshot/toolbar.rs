...
use st2k_appkit::win::{dpi_scale_dpi, gui_font, t, wide};
...
/// A handle to whichever icon font this machine actually has (`st2k_appkit::win::icon_font_face`)
...
unsafe fn icon_font(dpi: i32) -> HFONT {
    st2k_appkit::win::icon_font(dpi_scale_dpi(16, dpi))
}
