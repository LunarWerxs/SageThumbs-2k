...
use st2k_appkit::win::{result_buttons, result_edit, result_layout, run_dialog, t};
...
pub unsafe fn run_shot_upload_result(out: &str) -> bool {
...
extern "system" fn upload_result_proc(
    ...
    unsafe {
        ...
        if msg == WM_COMMAND && st2k_appkit::win::command_id(wparam) == ID_HISTORY {
