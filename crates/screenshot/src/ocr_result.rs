...
use st2k_appkit::win::window_shot::encode_png;
...
pub unsafe fn run_ocr(path: &str) {
...
pub unsafe fn run_ocr_keep(path: &str, page: Option<u32>) {
...
pub unsafe fn run_shot_ocr(out: &str, file: Option<&str>) -> bool {
