...
pub fn is_everything_class(cls: &str) -> bool {
...
pub unsafe fn everything_focus_window(fg: HWND) -> Option<HWND> {
...
pub unsafe fn everything_result_list(fg: HWND) -> Option<HWND> {
