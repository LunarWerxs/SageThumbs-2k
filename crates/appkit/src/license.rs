...
#[cfg(test)]
use nag::*;
pub use nag::{background_tick, nag_due, note_nag_shown, snapshot, LicenceSnapshot};
#[cfg(test)]
...
pub use st2k_base::licence_state::{
...
/// term.
pub const CERT_EXPIRY_WARNING_SECS: u64 = 30 * 24 * 60 * 60;
...
pub fn licence_reminder_body(snap: &LicenceSnapshot) -> String {
...
pub fn licence_reason_line(reason: &str) -> Option<&'static str> {
    match reason {
