...
pub const RELEASES_URL: &str = "https://github.com/LunarWerxs/SageThumbs-2k/releases";
...
pub const WM_APP_UPDATE: u32 = 0x8000 + 8;
...
pub fn offer_for(snap: &crate::license::LicenceSnapshot, latest: Option<&LatestRelease>) -> Offer {
    match latest {
...
pub fn lazy_check<F: FnOnce(String) + Send + 'static>(on_newer: F) {
