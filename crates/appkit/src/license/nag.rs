...
pub fn nag_due(now_unix: u64, posture: Posture) -> bool {
...
pub fn background_tick() -> Option<LicenceSnapshot> {
    start_trial_if_due();
...
pub fn note_nag_shown(now_unix: u64) {
    update_history(|h| {
...
pub fn snapshot() -> LicenceSnapshot {
