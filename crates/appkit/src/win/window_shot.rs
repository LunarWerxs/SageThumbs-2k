...
pub unsafe fn pull_top_down_bgra(
    dc: HDC,
    bmp: HBITMAP,
    w: i32,
    h: i32,
...
pub fn downscale_to_width(img: RgbaImage, target_w: u32) -> RgbaImage {
...
pub fn encode_gif(frames: &[RgbaImage], path: &Path, delay_ms: u16) -> bool {
...
pub fn to_rgba(top_down_bgra: &[u8], w: i32, h: i32) -> Option<image::RgbaImage> {
...
pub fn save_png_to_path(path: &std::path::Path, top_down_bgra: &[u8], w: i32, h: i32) -> bool {
