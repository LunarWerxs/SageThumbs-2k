...
pub unsafe fn pump_msgs(frames: usize) {
...
pub unsafe fn force_repaint(hwnd: HWND) {
...
/// `--dpi` override, here).
pub unsafe fn create_shot_window(
    hinst: HINSTANCE,
    dark: bool,
    class: PCWSTR,
    wndproc: WNDPROC,
...
pub unsafe fn capture_shot_window(
    out: &str,
    dark: bool,
...
pub unsafe fn settle_pump(hwnd: HWND, pump1: usize, pump2: usize, skip_final_repaint: bool) {
    pump_msgs(pump1);
    force_repaint(hwnd);
    pump_msgs(pump2);
