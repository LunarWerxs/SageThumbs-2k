...
pub unsafe fn result_buttons(hwnd: HWND, hinst: HINSTANCE, l: &ResultLayout) {
    ctl(
        hwnd,
        BUTTON,
        t("btn_copy"),
...
pub extern "system" fn result_window_proc<W: ResultWindow>(
    hwnd: HWND,
    msg: u32,
    wparam: WPARAM,
    lparam: LPARAM,
