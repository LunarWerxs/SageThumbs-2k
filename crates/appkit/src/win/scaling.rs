...
pub fn dpi_scale_dpi(v: i32, dpi: i32) -> i32 {
...
pub fn set_dpi_override(dpi: i32) {
...
pub fn dpi_override() -> Option<i32> {
...
pub fn dpi_scale(hwnd: HWND, v: i32) -> i32 {
...
pub fn dpi_unscale(hwnd: HWND, v: i32) -> i32 {
...
pub unsafe fn gui_font_for(hwnd: HWND) -> HFONT {
...
pub unsafe fn gui_font_sized(hwnd: HWND, px: i32, weight: i32) -> HFONT {
...
pub unsafe fn wm_dpichanged(hwnd: HWND, lparam: LPARAM) {
    if lparam.0 == 0 {
        return;
    }
