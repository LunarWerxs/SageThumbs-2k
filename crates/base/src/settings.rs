...
pub use app_prefs::{
    ...
    keep_metadata_on_convert, pdf_page, preserve_file_date, preview_arrow_nav, preview_blocked,
    preview_blocked_exts_raw, preview_close_on_focus_loss, preview_enabled, preview_hold_peek,
    preview_html, preview_loop, preview_markdown, preview_md_remote_img, preview_muted,
    preview_open_front, preview_pdf_strip, preview_speed, preview_text, preview_toc_open,
    preview_url_live, preview_volume, preview_window_size, screenshot_default_tool,
    screenshot_delay_sec, screenshot_hide_tray, screenshot_hotkey, screenshot_quick_hotkey,
    screenshot_save_dir, screenshot_use_save_dir, served_window_kind, set_app_theme,
    set_custom_action, set_custom_action_hotkey, set_cv_magick_quality, set_cv_settings,
    set_eyedropper_format, set_eyedropper_history, set_preview_arrow_nav, set_preview_blocked_exts,
