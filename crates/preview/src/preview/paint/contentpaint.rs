...
pub(super) unsafe fn paint_content(
    ...
    match st.kind.get() {
        ...
        ContentKind::Loading => paint_message(
            ...
            content_bg,
            subtle,
            st2k_appkit::win::t("preview_loading"),
        ),
...
pub(super) unsafe fn paint_content_image(
    ...
    let checker =
        st2k_base::settings::preview_checker().then(|| st2k_appkit::win::dpi_scale(hwnd, 12));
    ...
    let scrolled_pdf = super::super::pdfview::paint(
        hwnd,
        hdc,
        content_rc,
        content_bg,
        st2k_appkit::dark::BTN_FACE().0,
    );
...
pub(super) unsafe fn paint_content_markdown(
    ...
    let cols = super::super::markdown::MdColors {
        ...
        fg: text,
        muted: subtle,
        accent: st2k_appkit::dark::ACCENT_TEXT().0,
        code_bg: st2k_appkit::dark::DARK_BG().0,
        border: st2k_appkit::dark::BORDER().0,
        sel: st2k_appkit::dark::SEL_BG().0,
    };
    ...
    let w_full = st2k_appkit::win::dpi_scale(hwnd, 220);
