...
pub(super) unsafe fn on_geometry_msg(
    ...
    Some(match msg {
        ...
        WM_GETMINMAXINFO => {
            ...
            mmi.ptMinTrackSize.x = st2k_appkit::win::dpi_scale(hwnd, MIN_W);
            mmi.ptMinTrackSize.y = st2k_appkit::win::dpi_scale(hwnd, MIN_H);
            LRESULT(0)
        }
        ...
        WM_DPICHANGED => {
            st2k_appkit::win::wm_dpichanged(hwnd, lparam);
            LRESULT(0)
        }
        _ => return None,
    })
