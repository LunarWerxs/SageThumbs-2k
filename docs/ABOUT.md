...
- **a new supported thumbnail/preview format** - register the extension + category in the FORMATS table, then add a decoder under src/container/ (embedded-preview extraction) or src/decode/ (full decode). anchors: `crates/base/src/formats.rs`
