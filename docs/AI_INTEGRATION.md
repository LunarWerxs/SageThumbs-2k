...
|---|---|---|
| Decode **310 formats** → PNG (RAW, HEIC, PSD, MS Office, ebook/comic covers, PDF page 1, SVG, …) | image crate + WIC + bundled ImageMagick + resvg | `decode::decode_full` |
...
thumbnail <in> <out.png> [--size 256] # render any of the 310 types to PNG (default 256px)
