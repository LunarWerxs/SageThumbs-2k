...
pub use app_prefs::{
    ...
    screenshot_save_dir, screenshot_use_save_dir, set_app_theme, set_custom_action,
    set_custom_action_hotkey, set_cv_magick_quality, set_cv_settings, set_eyedropper_format,
    set_eyedropper_history, set_preview_arrow_nav, set_preview_blocked_exts,
