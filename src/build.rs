...
fn generate_locales() {
    ...
    write_keys_module(&mut out, &langs);
...
/// blank language.
fn read_locales(dir: &Path) -> BTreeMap<String, BTreeMap<String, String>> {
...
fn write_coverage_file(coverage: &str) {
...
fn write_keys_module(out: &mut String, langs: &BTreeMap<String, BTreeMap<String, String>>) {
    out.push_str(
...
fn write_dll_keys(out: &mut String, langs: &BTreeMap<String, BTreeMap<String, String>>) {
