...
![Formats](https://img.shields.io/badge/formats-336-2ea44f)
...
|  |  |
|---|---|
| 🖼️ **336 formats** | Camera RAW (Canon/Nikon/Sony/Fuji/…), PSD, GIMP XCF, DICOM, OpenEXR, FITS, HEIC/AVIF, JPEG-2000/XL/**XR**, Targa, SGI, and more |
...
| 📇 **Details pane & columns** | An **IPropertyStore** handler surfaces image dimensions, EXIF camera info and audio tags in Explorer's Details pane, hover tooltips, and sortable/groupable columns, for the 336 formats Windows can't read itself. Read-only and panic-isolated, like the thumbnailer |
...
|---|---|
| A RAW/PSD/HEIC **thumbnail or codec pack** (MysticThumbs, FastPictureViewer, Icaros) | Thumbnails for **336 formats**, crash-isolated so a corrupt file can't hang Explorer |
| A **preview-pane** add-on for RAW/PSD/ebook covers | A built-in large **preview handler** for 336 formats (reading pane and Open dialogs) |
...
<details open>
<summary><strong>336 extensions</strong> across Image, RAW, Ebook/comics, Document, Audio and Video</summary>
...
- **Project / design / CAD**: psd, afphoto/afdesign/afpub, clip, kra, ora, **pxo** (Pixelorama), **spla** (SpriteLoop, rendered), blend, 3mf, fcstd, gcode, **eps** (embedded raster preview only), **sketch, procreate** (digital art), **skp** (SketchUp), **3dm** (Rhino), **dwg** (AutoCAD), **max** (3ds Max), **c4d** (Cinema 4D), **xd** (Adobe XD), **cdr/cdt/cmx** (CorelDRAW / Corel Exchange)
...
336 as of this README, across image, camera RAW, ebook/comic, document, audio, and video; run
