...
![Formats](https://img.shields.io/badge/formats-349-2ea44f)
...
|  |  |
|---|---|
| 🖼️ **349 formats** | Camera RAW (Canon/Nikon/Sony/Fuji/…), PSD, GIMP XCF, DICOM, OpenEXR, FITS, HEIC/AVIF, JPEG-2000/XL/**XR**, Targa, SGI, and more |
...
| 📇 **Details pane & columns** | An **IPropertyStore** handler surfaces image dimensions, EXIF camera info and audio tags in Explorer's Details pane, hover tooltips, and sortable/groupable columns, for the 349 formats Windows can't read itself. Read-only and panic-isolated, like the thumbnailer |
...
|---|---|
| A RAW/PSD/HEIC **thumbnail or codec pack** (MysticThumbs, FastPictureViewer, Icaros) | Thumbnails for **349 formats**, crash-isolated so a corrupt file can't hang Explorer |
| A **preview-pane** add-on for RAW/PSD/ebook covers | A built-in large **preview handler** for 349 formats (reading pane and Open dialogs) |
...
<details open>
<summary><strong>349 extensions</strong> across Image, RAW, Ebook/comics, Document, Audio and Video</summary>
