...
| 🌗 **Native Win11 UI** | Redesigned **Settings** — a Win11-style category nav rail (General · File types · Ebook/comic · Right-click menu · Screenshots · Quick action · Advanced) with toggle switches, Common-Controls v6, **system-following dark mode**, 36 languages |
