...
![Formats](https://img.shields.io/badge/formats-347-2ea44f)
...
|  |  |
|---|---|
| 🖼️ **347 formats** | Camera RAW (Canon/Nikon/Sony/Fuji/…), PSD, GIMP XCF, DICOM, OpenEXR, FITS, HEIC/AVIF, JPEG-2000/XL/**XR**, Targa, SGI, and more |
...
| 📇 **Details pane & columns** | An **IPropertyStore** handler surfaces image dimensions, EXIF camera info and audio tags in Explorer's Details pane, hover tooltips, and sortable/groupable columns, for the 347 formats Windows can't read itself. Read-only and panic-isolated, like the thumbnailer |
...
|---|---|
| A RAW/PSD/HEIC **thumbnail or codec pack** (MysticThumbs, FastPictureViewer, Icaros) | Thumbnails for **347 formats**, crash-isolated so a corrupt file can't hang Explorer |
| A **preview-pane** add-on for RAW/PSD/ebook covers | A built-in large **preview handler** for 347 formats (reading pane and Open dialogs) |
...
<details open>
<summary><strong>347 extensions</strong> across Image, RAW, Ebook/comics, Document, Audio and Video</summary>
...
Bought [monthly](https://checkout.connections.icu/licence/c16cca94-53a4-4e7a-b434-0737fdfc21bb?slug=sagethumbs)
or [once](https://checkout.connections.icu/licence/24544461-9530-4edb-84e5-4f3471876d98?slug=sagethumbs)
