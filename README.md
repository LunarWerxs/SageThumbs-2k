...
- 🖼️ Explorer thumbnails for **312 file types it ignores** — camera RAW, Photoshop, HEIC/AVIF, **video (MKV, WebM, MP4, MOV…)**, JPEG-XR, MS Office, DjVu, ebooks & comics, 3D-print files, and the obscure long tail.
...
|  |  |
|---|---|
| 🖼️ **312 formats** | Camera RAW (Canon/Nikon/Sony/Fuji/…), PSD, GIMP XCF, DICOM, OpenEXR, FITS, HEIC/AVIF, JPEG-2000/XL/**XR**, Targa, SGI, and more |
...
- **Full** (~10.6 MB) bundles a hardened ImageMagick → all **312** formats.
...
<details open>
<summary><strong>312 extensions</strong> — Image 186 · RAW 34 · Ebook/comics 12 · Document 42 · Audio 16 · Video 22</summary>
